...
try:
    ...
    if isinstance(raw, dict) and raw.get("code") == "42703":
        logger.warning(
            ...
            "supabase_partners_mlm_portfolio_columns.sql, supabase_upcoming_next_month_payment_columns.sql."
        )
